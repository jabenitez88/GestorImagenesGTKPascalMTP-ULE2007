...
Const
  ...
  INSIMG = 'INSERT INTO imagen (nombre_imagen,descripcion,tipo,tematica,subtematica,anchura,altura,tamano,etiquetas,identificador) VALUES (';
  ...
  BusquedaIMG2a = 'SELECT imagen.id, imagen.nombre_imagen, imagen.descripcion, imagen.tipo, imagen.anchura, imagen.altura , imagen.tamano ,imagen.etiquetas ,subtematica.nombre_hijo,tematica.nombre, imagen.identificador';
  ...
  CreaTablaImg2 = ' default NULL,altura int default NULL,tamano bigint default NULL,etiquetas text,identificador varchar(15),PRIMARY KEY  (id),index (tematica),foreign key (tematica) references';
...
Type
      tTablaBusqueda = array [0..N,1..12] of string;	{ Tabla que almacenará la info de las imágenes cuando hacemos un busquedaDB }
