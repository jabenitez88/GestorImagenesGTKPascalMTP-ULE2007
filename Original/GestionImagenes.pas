...
Var datos	: PChar; 
    ...
    etiqueta,buscarepe 	: string;				{ INSERT INTO imagen (nombre_imagen,descripcion,tipo,id_subtematica,id_tematica,anchura,altura,tamano,etiquetas) }
    serepiteid	: boolean;
Begin 			
...
'",' + Num2St(idtematica) + ',' + Num2St(idsubtematica) + ',' + Num2St(ancho_img) + ',' + Num2St(alto_img) + ',' + Num2St(tamano_img) + '," ' + etiquetas + ' ","' + id_desc +'")';
